...
pub fn modify_nodes(_region_name: &str, _node_ids: &[u32]) -> ScFactoryModifyRegionNodes {
    ScFactoryModifyRegionNodes {
        tms: 0,
        name: _region_name.to_string(),
...
pub fn modify_components(_region_name: &str, _component_ids: &[(u32, u32)]) -> ScFactoryModifyRegionComponents {
...
pub fn modify_scene(_region_name: &str) -> ScFactoryModifyRegionScene {
